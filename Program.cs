using ConsoleMiniGames.MainMenu;
...
namespace ConsoleMiniGames {
	...
	internal partial class Program {
		...
		//			0 => Games.SeaBattle.SeaBattle.Start,
		//			1 => Games.MineSweeper.MineSweeper.Start,
		//			2 => Games.TicTacToe.TicTacToe.Start,
		//			3 => Games.Fifteens.Fifteens.Start,
		//			4 => Games.CowsBulls.CowsBulls.Start,
		//			_ => () => { },
		//		};
